...
/// @nodoc
mixin _$PokemonUseCaseException {
  ...
  @JsonKey(ignore: true)
  $PokemonUseCaseExceptionCopyWith<PokemonUseCaseException> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PokemonUseCaseExceptionCopyWith<$Res> {
  factory $PokemonUseCaseExceptionCopyWith(PokemonUseCaseException value,
          $Res Function(PokemonUseCaseException) then) =
      _$PokemonUseCaseExceptionCopyWithImpl<$Res, PokemonUseCaseException>;
  @useResult
...
/// @nodoc
class _$PokemonUseCaseExceptionCopyWithImpl<$Res,
        $Val extends PokemonUseCaseException>
    implements $PokemonUseCaseExceptionCopyWith<$Res> {
  _$PokemonUseCaseExceptionCopyWithImpl(this._value, this._then);
...
class __$$AlertImplCopyWithImpl<$Res>
    extends _$PokemonUseCaseExceptionCopyWithImpl<$Res, _$AlertImpl>
...
class _$AlertImpl implements Alert {
  ...
  @override
  String toString() {
    return 'PokemonUseCaseException.alert(state: $state)';
  }
...
abstract class Alert implements PokemonUseCaseException {
