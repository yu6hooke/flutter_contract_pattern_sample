import 'package:contract_pattern_sample/core/util/stream_extensions.dart';
...
class FakePokemonHandler {
  ...
  late AsyncValueSetter<int> fetchPokemonList = (page) async {
    fakeState.update((value) => value.copyWith(
